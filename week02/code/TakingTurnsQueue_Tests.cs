...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue added people to the front of the
    // queue, causing LIFO behavior instead of the required FIFO behavior.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Test Result: Failed before correction; passed after correction.
    // Defect(s) Found: PersonQueue.Enqueue caused LIFO behavior. Also, a
    // person with 0 turns was not re-enqueued even though 0 means infinite turns.
    ...
    // Test Result: Failed before correction; passed after correction.
    // Defect(s) Found: PersonQueue.Enqueue caused LIFO behavior. Also, a
    // person with negative turns was not re-enqueued even though negative
    // values mean infinite turns.
    ...
    // Test Result: Passed.
    // Defect(s) Found: None. The correct InvalidOperationException was thrown with
    // the message "No one in the queue."
